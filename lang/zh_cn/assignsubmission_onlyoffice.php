...
$string['enablecomment'] = '允许学生在评分后在文档中发表评论';
$string['enablecomment:label'] = '学生对已评分 ONLYOFFICE 文件的反馈';
$string['enablecomment_help'] = '启用后，在您评分后，学生可以在 ONLYOFFICE 文档中直接留下评论。';
...
$string['mentionmessage:gotofile'] = '前往<a href="{$a->url}">作业提交</a>查看评论。';
...
$string['templatetype:custom'] = '编辑默认模板';
$string['templatetype:empty'] = '从空白文档开始';
